...
class PdcylComp(ExternalCode):
    ...
    fcsb   = Float(iotype='in', units='psi', desc="Compressive Strength on Bottom")
    est    = Float(iotype='in', units='psi', desc="Young's Modulus for the shells Top")
    esb    = Float(iotype='in', units='psi', desc="Young's Modulus for the shells Bottom")
    eft    = Float(iotype='in', units='psi', desc="Young's Modulus for the frames Top")
    efb    = Float(iotype='in', units='psi', desc="Young's Modulus for the frames Bottom")
    dst    = Float(iotype='in', units='lb/inch**3', desc="Density of shell material on Top")
    dsb    = Float(iotype='in', units='lb/inch**3', desc="Density of shell material on Bottom")
    dft    = Float(iotype='in', units='lb/inch**3', desc="Density of frame material on Top")
    dfb    = Float(iotype='in', units='lb/inch**3', desc="Density of frame material on Bottom")
    tmgt   = Float(iotype='in', units='inch', desc="Minimum gage thickness Top")
    tmgb   = Float(iotype='in', units='inch', desc="Minimum gage thickness Bottom")
    ...
    pgb     = Float(iotype='in', units='psi', desc="Fuselage gage pressure on bottom")
